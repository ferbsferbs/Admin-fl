        ...
        >
              ...
              <div className="card mb-3 widget-chart">
                <div className="widget-chart-content">
                  ...
                  <div className="widget-subheading">
                    Colegio con mas docentes: {this.state.data.mainInfo.mostDocentes.name}
                  </div>
            ...
            <Col lg="4">
              <div className="card mb-3 widget-chart">
                <div className="widget-chart-content">
                  ...
                  <div className="widget-numbers">{this.state.data.mainInfo.mostAulas.number}</div>
                  <div className="widget-subheading">
                  Colegio con mas aulas: {this.state.data.mainInfo.mostAulas.name}
                  </div>
                  <div className="widget-description text-success"></div>
                </div>
                <div className="widget-chart-wrapper chart-wrapper-relative">
            ...
            <Col lg="4">
              <div className="card mb-3 widget-chart">
                <div className="widget-chart-content">
                  ...
                  <div className="widget-subheading">
                  Colegio con mas alumnos: {this.state.data.mainInfo.mostAlumnos.name}
                  </div>
                  <div className="widget-description text-success"></div>
                </div>
                <div className="widget-chart-wrapper chart-wrapper-relative">
          ...
          <Col lg="12">
            <Card className="main-card mb-3">
              <CardBody>
                <CardTitle>Instituciones Inscriptas </CardTitle>
